...
public:
   ...
   uint64_t last_event_number;

   TriggerData()
      : first_event_number(0), last_event_number(0) {}

   TriggerData(uint64_t first_event_number, uint64_t last_event_number)
      : first_event_number(first_event_number), last_event_number(last_event_number) {}
};
